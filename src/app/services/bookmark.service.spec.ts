...
describe('BookmarkService', () => {
    ...
    beforeEach(() => {
        const spy = jasmine.createSpyObj('PreferencesService', ['getBookmarks', 'setBookmarks']);
        ...
        preferencesServiceSpy = TestBed.inject(PreferencesService) as jasmine.SpyObj<PreferencesService>;
    });
    ...
    it('should replace an existing bookmark if color is the same', () => {
        ...
        expect(bookmarks.find(b => b.bookId === 'JHN' && b.color === '#F44336')).toBeTruthy();
    });
