...
describe('BookmarkSelectorComponent', () => {
    ...
    let bottomSheetRefSpy: jasmine.SpyObj<MatBottomSheetRef<BookmarkSelectorComponent>>;
    ...
    beforeEach(async () => {
        const bookmarkSpy = jasmine.createSpyObj('BookmarkService', ['getBookmarks', 'addBookmark', 'removeBookmark']);
        const bookSpy = jasmine.createSpyObj('BookService', ['findBook', 'getUrlAbrv']);
        ...
        await TestBed.configureTestingModule({
            imports: [BookmarkSelectorComponent, CommonModule, MatButtonModule, MatIconModule],
            providers: [
        ...
        bottomSheetRefSpy = TestBed.inject(MatBottomSheetRef) as jasmine.SpyObj<MatBottomSheetRef<BookmarkSelectorComponent>>;
    ...
    it('should add bookmark when clicking an empty ribbon', () => {
        ...
        expect(bookmarkServiceSpy.addBookmark).toHaveBeenCalledWith('GEN', 1, '#F44336');
